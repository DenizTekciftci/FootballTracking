...
camera_movement_per_frame = camera_movement_estimator.get_camera_movement(video_frames, True, 'stubs/camera_movement_stub.pkl')
...
team_assigner.assign_team_color(video_frames[0], tracks['players'][0]) # first frame player detections
